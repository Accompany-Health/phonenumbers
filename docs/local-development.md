...
This fetches the latest XML/text files from Google's libphonenumber, gzips them, and overwrites the files in `data/`. Commit the result and update `CHANGELOG.md` with the upstream metadata version.
